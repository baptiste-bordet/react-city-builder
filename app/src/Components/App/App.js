...
class App extends Component {
    ...
    goToPage(page) {
        ...
        setTimeout(function() { this.setState({scrollLock: false}); }.bind(this), 800);
    }

    render() {
        return (
            <Parallax ref={ref => (this.parallax = ref)} pages={3.1} scrolling={false}>
                ...
                <Parallax.Layer offset={2.1} factor={0.8} speed={0} style={{ backgroundColor: '#b5b5b7', opacity: '0.95' }}
